...
class Document:
    ...
    def tokenize(self, use_stemming=True):
        ...
        for line in self.lines:
            ...
            if use_stemming:
                ...
                tokenized_lines.extend(stemmed_tokens)
            else:
                tokenized_lines.extend(tokens)
...
class Sonnet(Document):
    def __init__(self, sonnet_dictionary):
        super().__init__(sonnet_dictionary["lines"])
        self.id = sonnet_dictionary["title"].split(" ")[1][:-1]
        self.title = ' '.join(sonnet_dictionary["title"].split(" ")[2:])
...
if x.status_code == 200:
    sonnets_dictionary_list = x.json()
    sonnets_list = list(map(Sonnet, sonnets_dictionary_list))
